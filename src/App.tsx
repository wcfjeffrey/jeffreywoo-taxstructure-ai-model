...
export default function App() {
  ...
  const addEntity = (type: EntityType) => {
    const formattedType = type.toLowerCase().split('_').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ');
            ...
            <div className="p-4 space-y-6">
              <section>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button onClick={() => addEntity(EntityType.COMPANY_LIMITED_BY_SHARES)} className="flex items-center gap-2 p-2 text-[11px] border border-line rounded hover:bg-bg">
                    <Building2 size={14} /> Co. Ltd by Shares
                  </button>
                </div>
              </section>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="space-y-1">
                      ...
                      <button onClick={() => applyTemplate(OFFSHORE_CHAIN_TEMPLATE)} className="w-full text-left p-2 text-[11px] border border-line rounded hover:bg-bg">HK/BVI/Cayman Chain</button>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-4 py-2">
                      ...
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input 
                          type="checkbox"
                          checked={selectedEntity.isWFOE || false}
                          onChange={(e) => updateEntity(selectedEntity.id, { isWFOE: e.target.checked })}
                          className="rounded border-line text-ink focus:ring-ink"
                        />
                        <span className="text-[10px] font-mono uppercase">WFOE</span>
                      </label>
                    </div>
                    <div>
